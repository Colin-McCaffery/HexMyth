...
import hexdoc_hexmyth

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexmythPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexmythModPlugin(branch=branch)


class HexmythModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexmyth"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexmyth, "_templates"
