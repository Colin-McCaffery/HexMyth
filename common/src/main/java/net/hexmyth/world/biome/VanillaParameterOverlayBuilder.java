...
// To anyone looking at this in HexMyth, this is a part of the Terrablender API that I needed to copy (not import) for the biome to work. It wouldn't import for some reason.
